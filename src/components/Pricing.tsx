...
const freeTier = {
  ...
  features: [
    "Live trade feed — no delay, updated as filings land",
    "Browse all 173 tracked members",
    "Basic analytics (overview, parties)",
    "Up to 3 bookmarks",
    "Search & filter trades",
  ],
  excluded: [
    "Signals — cluster buys, whales & conviction",
    "Committee conflict scoring",
    "Top trader rankings",
    "AI trade analysis",
    "Lobbying context",
...
const proTier = {
  ...
  features: [
    ...
    "Signals — ticker scores, cluster buys & whale trades",
    "Committee conflict scoring (0-100)",
    "Top trader rankings by real return",
    "Suspicious pre-disclosure move detection",
