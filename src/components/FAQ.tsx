...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Free gives you the live trade feed with no delay, access to all 173 tracked members, up to 3 bookmarks, and basic overview analytics. Pro unlocks the full 2-year history, Signals (ticker scores, cluster buys, whale trades and conviction), committee conflict scoring, top-trader rankings, suspicious pre-disclosure move detection, AI pattern analysis, lobbying context, sector heatmaps, push notifications, CSV export, and unlimited bookmarks. Pro is $6.99/month or $49.99/year.",
  },
  {
